...
function processText(action) {
    ...
    if (inputText.trim() === '') {
        ...
        outputContainer.style.display = 'none';
        placeholderImage.style.display = 'block';  // Mostrar la imagen de la varita
    ...
    if (resultText.trim() === '') {
        ...
        setTimeout(() => {
            ...
            placeholderImage.style.display = 'none';  // Ocultar la imagen de la varita
...
function clearText() {
    ...
    // Verificar si está en modo responsive
